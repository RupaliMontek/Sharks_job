...
<!--modal end here -->
      ...
      <button type="button" class="btn-link nav-item dropdown fremployers">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" data-toggle="modal" data-target="#exampleModal">Log In</a>
          <a class="dropdown-item" href="<?= base_url("registration/candidate"); ?>">Resume Builder</a>
          <a class="dropdown-item" href="<?= base_url("registration/candidate"); ?>">AI Interview Preparation</a>
          <a class="dropdown-item" href="<?= base_url("registration/candidate"); ?>">Career Mentorship</a>
          <a class="dropdown-item" href="<?= base_url("registration/candidate"); ?>">Apply A Job</a>
        </div>
      </button>
        <button type="button" class="btn-link nav-item dropdown fremployers">
